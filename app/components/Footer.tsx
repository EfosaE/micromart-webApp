...
const Footer = () => {
  return (
    <footer className='bg-secondary font-space text-white py-10'>
      <div className='container px-4 grid grid-cols-1 md:grid-cols-4 gap-4'>
        {/* About Section */}
        <div>
          <h3 className='text-lg font-semibold mb-4'>About MicroMart</h3>
          <p className='text-sm text-slate-200 text-xs md:text-sm'>
            Your Company is a leading e-commerce platform offering a wide range
            of products with the best deals and reliable customer support.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className='space-y-2'>
            <li>
              <a href='#' className='text-slate-200 text-xs md:text-sm hover:text-white transition'>
                Help Center
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <form className='flex'>
            <input
              ...
              className='px-4 py-2 rounded-l-md focus:outline-none text-gray-900'
            />
            <button
              type='submit'
              className='px-4 py-2 bg-orange text-white rounded-r-md hover:bg-blue-700 transition'>
              Subscribe
            </button>
          </form>
        </div>
